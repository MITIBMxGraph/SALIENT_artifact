...
JOB_NAME=single_gpu_salient_$1
...
if [[ "$1" = "ogbn-arxiv" ]]	|| [[ "$1" = "ogbn-products" ]] || [[ "$1" = "ogbn-papers100M" ]]; then
	...
	--config_file $SCRIPT_DIR/performance_breakdown_config.cfg --dataset_root $DATASET_ROOT --output_root $OUTPUT_ROOT --overwrite_job_dir
else
